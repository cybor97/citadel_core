...
const BALANCE_QUERY = `
    SELECT SUM(CASE WHEN transactions.from = transactions.to THEN 0 WHEN transactions.from = :address THEN -transactions.value ELSE transactions.value END) - SUM(transactions.fee) as balance
    FROM transactions
