...
router
        ...
        for (let address of addresses) {
            try {
                if (!addressesRequested || addressesRequested.includes(address.address)) {
                    ...
                    transactions = utils.getUniqueTransactions(transactions);
    ...
    */
    ...
    .get('/:net/user/:userId/reward-total', async (req, res) => {
        ...
        let result = await explorerUpdater.getRewardTotal(req.params.net, req.params.userId, !req.query.add_balance);
